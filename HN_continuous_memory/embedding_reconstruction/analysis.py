...
def load_data(N, basis, mask):
    filename = f"/mnt/data-poseidon/saul/continuous_HN/embedding_reconstruction/results/beta_10.0_nb_basis_{basis}_num_iters_1_N_{N}_resolution_224_noise_{mask}.json"
...
for i, (discrete_agg, discrete_std, continuous_mean, continuous_std, basis, title) in enumerate(data):
    ...
    axs[row, col].set_ylim(0.85, 0.95)  # Set y-axis limits
