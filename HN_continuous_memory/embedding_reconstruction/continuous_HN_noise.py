...
def parse_args():
    ...
    parser.add_argument("--std", nargs="+", type=float, required=True, help="mask percentage")
    parser.add_argument(
        "--options",
        nargs="+",
...
def main(args):
    ...
    output_file = f"embedding_reconstruction/results/beta_{args.beta}_nb_basis_{args.nb_basis}_num_iters_{args.num_iters}_N_{args.N}_resolution_{args.resolution}_std_{args.std}.json"
    results = {}
